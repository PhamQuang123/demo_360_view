...
const My360View = () => {
  ...
  const [fileName, setFileName] = useState("DJI_0001.JPG");
  ...
  //     // return `DJI_00${index < 10 ? `0${index}` : index}.JPG`;
  //     return `DJI_000${index}.JPG`;
  //   };

  //   useEffect(() => {
  //     const newFileName = `DJI_00${index < 10 ? `0${index}` : index}.JPG`;
  //     setFileName(newFileName);
  //     console.log(fileName);
  //   }, [index]); // Cập nhật fileName khi index thay đổi
  return (
    <div>
      ...
      {/* <div>
        <React360Viewer
          imagesBaseUrl="/100_0404  "
          imagesCount={totalFrames} // Số lượng hình ảnh
          imagesFiletype="jpg" // Định dạng file
